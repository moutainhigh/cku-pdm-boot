...
public class BasMaterialType implements Serializable {
	...
	/**是否检验*/
	@Excel(name = "是否检验", width = 15, dicCode = "is_test")
	@Dict(dicCode = "is_test")
	...
	/**库房分类*/
	@Excel(name = "库房分类", width = 15, dicCode = "house_type")
	@Dict(dicCode = "house_type")
