 ...
 */
@Data
@TableName("admin_field_value")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="admin_field_value", description="admin_field_value")
public class AdminFieldValue implements Serializable {
    ...
    /**字段宽度*/
    @Excel(name = "主表信息id", width = 15)
    @ApiModelProperty(value = "主表信息id")
