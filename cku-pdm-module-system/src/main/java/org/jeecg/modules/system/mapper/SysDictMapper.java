...
public interface SysDictMapper extends BaseMapper<SysDict> {
	...
	@Select("SELECT * FROM sys_dict WHERE DICT_CODE = #{DICT_CODE}")
	public Map<String,Object> getType(String DICT_CODE);

	public Long duplicateCheckOfFieldsCountSql(Map map);
	public Long duplicateCheckOfFieldsCountSqlNoDataId(Map map);

	/**
	 * 根据多个key获取多个text值，用逗号分隔
	 * @param code
	 * @param keyArray
	 * @return
	 */
	public String getItemTextsByKeys(@Param("code") String code, @Param("keyArray") String[] keyArray);
}
